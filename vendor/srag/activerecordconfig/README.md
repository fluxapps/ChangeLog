...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\ChangeLog\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\ChangeLog\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\ChangeLog\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
